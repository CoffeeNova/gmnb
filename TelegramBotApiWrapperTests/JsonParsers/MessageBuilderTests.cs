...
namespace CoffeeJelly.TelegramBotApiWrapper.JsonParsers.Tests
{
    [TestClass]
    public class MessageBuilderTests
    {
        ...
        public void TestInitialize()
        {
            ...
            switch (TestContext.TestName)
            {
                ...
                case nameof(BuildMessage_ForwardedVideoJSON_TelegramForwardedVideoMessage):
                    ...
                    break;
                case nameof(BuildMessage_ServiceMessageJSON_ServiceMessage):
                    _messageToken = ReadJsonMessageFromFile(_serviceMessageFileName);
                    break;
                    #endregion
            }
        ...
        [TestMethod]
        public void BuildMessage_ServiceMessageJSON_ServiceMessage()
        {
            ...
            AttachGeneralProperties(expected);
            var actual = MessageBuilder.BuildMessage<ServiceMessage>(_messageToken);
            var compareLogic = new CompareLogic(_config);
            var comparisonResult = compareLogic.Compare(expected, actual);
        ...
        private static string _serviceMessageFileName = "SampleServiceMessage.json";
